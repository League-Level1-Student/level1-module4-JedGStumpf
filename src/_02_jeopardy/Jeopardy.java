...
public class Jeopardy implements ActionListener {
	...
	private int score = 0;
	private JLabel scoreBox = new JLabel(Integer.toString(score));
	...
	public void run() {
		...
		JPanel header = createHeader("Dinosaurs");
...
//		JOptionPane.showMessageDialog(null, "pressed " + ((JButton) e.getSource()).getText() + " button");
		...
		if (buttonPressed == firstButton) {
			...
			askQuestion("TREX is a carnivore", "True", 200);
			firstButton.setText(null);
			firstButton.setEnabled(false);
			
		} else if (buttonPressed == secondButton) {
			askQuestion("Did they have feathers", "True", 300);
